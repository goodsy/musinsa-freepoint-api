...
import com.musinsa.freepoint.adapters.out.persistence.JpaPointUsageDetailRepository;
import com.musinsa.freepoint.adapters.out.persistence.JpaPointUsageRepository;
...
public class UsePointUseCase {
    ...
    public UsePointUseCase(JpaPointAccrualRepository accrualRepo, JpaPointUsageRepository usageRepo, JpaPointUsageDetailRepository detailRepo, JpaPointWalletRepository walletRepo) {
        this.accrualRepo = accrualRepo; this.usageRepo = usageRepo; this.detailRepo = detailRepo; this.walletRepo = walletRepo;
    }
