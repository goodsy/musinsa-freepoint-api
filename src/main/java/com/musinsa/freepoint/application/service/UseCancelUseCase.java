...
public class UseCancelUseCase {
    ...
    public UseCancelUseCase(JpaPointUsageRepository usageRepo, JpaPointUsageDetailRepository detailRepo,
                            JpaPointAccrualRepository accrualRepo, JpaPointWalletRepository walletRepo) {
        this.usageRepo = usageRepo; this.detailRepo = detailRepo; this.accrualRepo = accrualRepo; this.walletRepo = walletRepo;
    }
