...
import com.musinsa.freepoint.application.port.in.Commands.UseCommand;
import com.musinsa.freepoint.application.port.in.Commands.CancelUseCommand;
...
public class UsageController {
    private final UsePointUseCase useCase;
    private final UseCancelUseCase cancelUseCase;
    public UsageController(UsePointUseCase useCase, UseCancelUseCase cancelUseCase) {
        this.useCase = useCase; this.cancelUseCase = cancelUseCase;
    }
